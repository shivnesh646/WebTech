...
document.getElementById("bmi-compute").addEventListener("click", (e) => {
    ...
    if (bmi < 24.9 && bmi>18.6 ) document.getElementById("bmi-type-output").innerText = "Normal";
    if (bmi < 29.9 && bmi>25) document.getElementById("bmi-type-output").innerText = "Overweight";
...
document.getElementById("flip").addEventListener("click", (e) => {
    if (Math.random() > 0.5) {
        document.getElementById("coin-img").setAttribute("src", "head.png");
        document.getElementById("heads-total").innerText = ++heads;
    } else {
        document.getElementById("coin-img").setAttribute("src", "tail.jpg");
...
document.getElementById("farm-compute").addEventListener("click", (e) => {
    ...
    for (let i = 0; i < rows; i++) {
        ...
        for (let j = 0; j < columns; j++) {
            const image = Math.random() > 0.5 ? "Apple.png" : "Orange.png";
